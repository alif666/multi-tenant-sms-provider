...
1. **Critical** - `formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelService.java:30-37`
   ...
   - Fixed. sendSms() now resolves the provider through TenantProviderRegistry.resolveProvider(message.tenantId(), properties.getProvider()) before using the global default.
      - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelService.java:47 and /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/TenantProviderRegistry.java:24.
...
2. **Critical** - `formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelService.java:30-37`
   ...
   - Fixed. After a successful send, it now calls costService.recordCost(message.tenantId(), message.to(), result).
   - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelService.java:30.
...
3. **High** - `formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelService.java:35-39`
   ...
   - Fixed. sendWithRetry() now uses SmsChannelProperties.RetryProperties, retries retryable failures, and applies bounded backoff.
   - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelService.java:76 and /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/api/SmsChannelProperties.java:61. 
...
4. **High** - `formwork-channel-sms/src/main/java/one/formwork/channel/sms/provider/AwsSnsSmsGateway.java:41-112`
   ...
   - Fixed. The gateway now uses an encode() helper that converts spaces to %20 and applies RFC3986-style adjustments.
   - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/provider/AwsSnsSmsGateway.java:137.
...
5. **High** - `formwork-channel-sms/src/main/java/one/formwork/channel/sms/provider/AwsSnsSmsGateway.java:39-85`
   ...
   - Fixed. AwsSnsSmsGateway now has constructor overloads that accept accessKey and secretKey, with env vars only used as the default production path.
   - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/main/java/one/formwork/channel/sms/provider/AwsSnsSmsGateway.java:39.
...
6. **Medium** - `formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/TwilioSmsGatewayWireMockTest.java:43-55`
   ...
   - Not fixed in the reviewed test file. The test still mocks WebClient chains rather than asserting a live HTTP request contract.
   - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/TwilioSmsGatewayWireMockTest.java:43.
...
7. **Medium** - `formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/MessageBirdSmsGatewayWireMockTest.java:40-52`
   ...
   - Not fixed in the reviewed test file. It still only exercises mocked client behavior, not the actual request bytes.
   - See /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/MessageBirdSmsGatewayWireMockTest.java:40.
...
8. **Low** - `formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/AwsSnsSmsGatewayTest.java:17-35`
   ...
   - Partially fixed. The original unit test still only checks supports() and getProviderName(), but there is now a separate integration test that exercises send() and verifies the encoded query string and headers.
   - Reviewed file still lacks send() coverage: /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/AwsSnsSmsGatewayTest.java:17
   - New coverage exists here: /C:/Users/USER/Documents/springboot/sbja-github/formwork-channel-sms/src/test/java/one/formwork/channel/sms/provider/AwsSnsSmsGatewayHttpIntegrationTest.java:32
